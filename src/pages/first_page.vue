<template>
    <div
        class="flex flex-col space-y-4 fixed bg-white rounded-lg px-6 py-6 ring-1 ring-slate-900/5 shadow-xl shadow-violet-500/30 left-48 top-32">
        <div class="text-left">
            ...
            <form class="bg-white shadow-md shadow-indigo-500/50 rounded px-8 pt-6 pb-8 mb-4">
                <div class="mb-4">
                    ...
                    <input
                        ...
                        id="username" type="text" placeholder="имя пользователя">
                </div>
                <div class="mb-6">
